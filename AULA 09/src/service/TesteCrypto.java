...
import exercicio2.LeitorDeBytes;

public class TesteCrypto {
	public static void main(String[] args) throws Exception {
		byte[] bMsgClara = LeitorDeBytes.ler("mensagem_original.txt");
		byte[] bMsgCifrada = null;
		byte[] bMsgDecifrada = null;
		String sMsgClara = new String(bMsgClara, "ISO-8859-1");
		...
		cdummy.geraCifra(bMsgClara, new File("chave.dummy")); // Recebe o texto
																// cifrado
		...
		// simetrica gerada
		cdummy.geraDecifra(bMsgCifrada, new File("chave.dummy")); // recebe o
																	// texto
																	// decifrado
		...
		crsa.geraParDeChaves(new File("chave.publica"), new File(
				"chave.privada")); // Gera a cifra RSA da mensagem dada, segundo
									// a chave publica gerada
		crsa.geraCifra(bMsgClara, new File("chave.publica")); // Recebe o texto
																// cifrado
		...
		crsa.geraDecifra(bMsgCifrada, new File("chave.privada")); // recebe o
																	// texto
																	// decifrado
